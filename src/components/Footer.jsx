            ...
            <div className="flex flex-col md:flex-row  gap-4 md:gap-12 pt-8 md:pt-4  ">
              <div className="flex flex-wrap flex-col gap-4 ">
                ...
                <div className="flex items-center cursor-default">
                  ...
                  <span className="text-slate-300 px-2">Instagram</span>
                </div>
                {/* FACEBOOK */}
                <div className="flex  items-center cursor-default">
                  <Link
                  ...
                  <span className="text-slate-300 px-2">Facebook</span>
                </div>
                {/* TWTITER */}
                <div className="flex  items-center cursor-default">
                  <Link
                  ...
                  <span className="text-slate-300 px-2">Twitter</span>
                </div>
              </div>
              <div className="flex flex-wrap flex-col gap-4">
                {/* YOUTUBE */}
                <div className="flex  items-center cursor-default">
                  ...
                  <span className="text-slate-300 px-2">Youtube</span>
                </div>
                {/* TIKTOK */}
                <div className="flex  items-center cursor-default">
                  <Link
                  ...
                  <span className="text-slate-300 px-2">TikTok</span>
                </div>
              </div>
            </div>
          </div>
