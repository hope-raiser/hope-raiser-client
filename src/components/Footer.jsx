			...
			<div className="container mx-auto">
				<div className="flex flex-wrap gap-12 px-12 py-16   lg:justify-between items-center">
					<div className="w-full lg:w-1/3 ">
						<div className="flex px-2 items-center">
							...
							<div className="flex flex-wrap flex-col px-4 text-center">
								<h2 className="text-teal-500 text-2xl font-bold tracking-wider">
									HOPERAISER
								</h2>
						...
						<div className="pt-4 md:pt-8 md:w-2/3">
							<p className="text-slate-300 text-sm font-light">
								Fundly is dedicated to providing you with the
								tools you need to raise money for whatever your
								cause may be.
							</p>
						</div>
					</div>
					<div className="w-full lg:w-1/3 ">
						<h3 className="text-teal-500 text-xl  font-normal tracking-wider mb-4">
							NAVIGATION
						</h3>
					...
					<div className="w-full lg:w-auto ">
						<h2 className="text-teal-500 text-xl md:px-4 font-normal tracking-wide">
							FOLLOW US
						</h2>
