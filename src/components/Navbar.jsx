        ...
        <div className="flex flex-wrap p-4 md:px-4  items-center gap-4 justify-around">
          <Link href="/">
            <div className="flex items-center">
              <Image
                src="/logo.png"
                fallback="https://placehold.co/55"
                alt="LOGO"
              ...
              <div className="flex flex-wrap flex-col px-4 text-center">
                ...
                <span className="text-Dark text-xs  tracking-widest hidden md:block">
                  Empowering Hope, Fueling Progress
                </span>
              </div>
            </div>
          </Link>
          ...
          <ul className="text-Dark text-lg font-medium hidden md:flex gap-10 ">
            ...
            <Link
              href={isLogin ? "/users/bookmark" : "/login"}
                  ...
                  {isOpen && (
                    <div className="absolute right-0 z-10 mt-2  bg-slate-50 rounded-sm shadow-md ">
                      <ul className="py-2 px-8 ">
                        <Link href="/users">
                          <li className="cursor-pointer mb-4 py-1  text-Dark hover:text-Teal duration-300">
                            Profile
                          </li>
                        </Link>
          ...
          >
            <div className="flex flex-wrap overflow-auto items-center justify-around">
              <Link href="/">
                <div className="flex items-center ">
                  <Image
                    src="/logo.png"
                    fallback="https://placehold.co/60"
                    alt="LOGO"
                    className="text-Dark font-semibold"
                    boxSize="60px"
                  />
            ...
            <ul
              className="text-white text-md  font-medium pt-8"
            ...
            >
              ...
              <Link
                href={isLogin ? "users" : "/login"}
                className="block py-4 mt-8  border-b border-gray-700"
              >
                Profile
              </Link>
              <Link
                href={isLogin ? "campaigns/create" : "/login"}
                className="block py-4 border-b border-gray-700"
              >
                Create Campaign
              </Link>
