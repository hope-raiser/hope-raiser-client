...
import { SimpleGrid, CircularProgress, Box, HStack, Text, Flex, IconButton, Container, Center } from "@chakra-ui/react";
...
const Home = ({ query }) => {
  ...
  return (
    <Layout user={userData}>
      <SimpleGrid mt="3" p="5" columns={3} spacing={6} justifyContent="center" minHeight={"100vh"}>
